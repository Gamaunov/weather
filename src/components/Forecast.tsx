...
const Forecast = ({ data }: Props) => {
  ...
  return (
    <div className="backdrop-blur-ls h-full w-full rounded bg-white bg-opacity-20 py-4 drop-shadow-lg md:max-w-[500px] md:px-10 md:py-4 lg:h-auto lg:px-24">
      <div className="mx-auto w-[300px]">
        <section className="text-center">
          <h2 className="text-2xl font-black">
            {data.name} <span className="font-thin text-cyan-950">{data.country}</span>
          </h2>
